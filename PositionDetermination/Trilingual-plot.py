...
def color (de, hu, sr, other):
    ...
    if Total:
        ...
        green = hu/Total
        blue = sr/Total
        return Total/10, red, green, blue
    else:
        return 0,0,0,0
...
plt.scatter(kx, ky, transform=ccrs.PlateCarree())
plt.show()
...
plt.scatter(kx81, ky81, size, colorplot81)
plt.show()
...
plt.scatter(kx00, ky00, size, colorplot00)
plt.show()
...
plt.scatter(kx10, ky10, size, colorplot10)
plt.show()
...
plt.scatter(kx20, ky20, size, colorplot20)
plt.show()